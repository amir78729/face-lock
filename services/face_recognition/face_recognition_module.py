...
def _raw_face_landmarks(face_image, _face_locations=None, model='large'):
...
def face_landmarks(face_image, _face_locations=None, model='large'):
    """
    ...
    """
    landmarks = _raw_face_landmarks(face_image, _face_locations, model)
